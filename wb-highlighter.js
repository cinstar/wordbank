// alert('Hello world from wb-highlighter.js');
...
// dynamic styling for highlighter
...
class WBHighlighter extends HTMLElement {
    get markerPosition() {
  ...
  window.customElements.define("wb-highlighter", WBHighlighter);
